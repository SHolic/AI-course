...
def main():
    ...
    for model_type in MODEL_TYPE:
        ...
        torch.save(model.get_model().state_dict(), f"models/model_path_{model_type}.pth")
        print(f"Model saved to models/model_path_{model_type}.pth")

        # Load the model
        model.get_model().load_state_dict(torch.load(f"models/model_path_{model_type}.pth"))
    ...
    print(f"Metrics saved to metrics/metrics.json")
